...
NL = {
    ...
    "Mes révisions": "Mijn herzieningen",
    "Voir tout →": "Alles zien →",
    # Corrections (wrong values from previous run)
    "Masquer": "Verbergen",
    "Voir les options": "Opties bekijken",
    "Voir les résultats": "Resultaten bekijken",
    "Question suivante →": "Volgende vraag →",
    "correctes": "correct",
    "questions correctes": "correcte vragen",
    "Voir tous": "Alle bekijken",
    # New strings — Part B templates
    "Par %(author)s": "Door %(author)s",
    "Articles similaires": "Gerelateerde artikelen",
    "Aperçu admin — Question #%(id)s": "Admin preview — Vraag #%(id)s",
    "pause": "pauze",
    "Confirmer": "Bevestigen",
    "Temps écoulé !": "Tijd verstreken!",
    "Bonne réponse !": "Goed antwoord!",
    "Mauvaise réponse": "Fout antwoord",
    "Aperçu terminé": "Preview klaar",
    "Félicitations !": "Gefeliciteerd!",
    "Continuez à vous entraîner": "Blijf oefenen",
    "%(s)s / %(t)s bonnes réponses": "%(s)s / %(t)s goede antwoorden",
    "Temps :": "Tijd:",
    "Détail des réponses": "Detail van de antwoorden",
    "Cliquez sur le signet pour sauvegarder": "Klik op de bladwijzer om op te slaan",
    ...
    "Moyen": "Gemiddeld",
    "Difficile": "Moeilijk",
    "répondues": "beantwoord",
    "Article précédent": "Vorig artikel",
    "Article suivant": "Volgend artikel",
    "Sommaire — %(name)s": "Inhoudsopgave — %(name)s",
    "← Précédent": "← Vorige",
    "Suivant →": "Volgende →",
    "Apprenez à reconnaître tous les panneaux routiers belges.": "Leer alle Belgische verkeersborden herkennen.",
    "Explication": "Uitleg",
    "autres": "andere",
    ...
    # Theme cards — index.html
    "Règles de circulation": "Verkeersregels",
    "Priorité, vitesse, dépassement\u2026": "Voorrang, snelheid, inhalen\u2026",
    "Infrastructure et signalisation": "Infrastructuur en signalisatie",
    "Panneaux, marquages, feux\u2026": "Verkeersborden, wegmarkering, lichten\u2026",
    "Politique criminelle": "Strafrechtelijk beleid",
    "Sanctions, amendes, procédures\u2026": "Sancties, boetes, procedures\u2026",
    "Permis de conduire": "Rijbewijs",
    "Catégories, examen, validité\u2026": "Categorieën, examen, geldigheid\u2026",
    "Assurance et immatriculation": "Verzekering en registratie",
    "Plaques, assurance RC, contrôle\u2026": "Nummerplaten, BA-verzekering, controle\u2026",
    "Transport de marchandises": "Goederenvervoer",
    "ADR, poids lourds, chargement\u2026": "ADR, vrachtwagens, lading\u2026",
    "Transport de personnes": "Personenvervoer",
    "Bus, taxis, covoiturage\u2026": "Bus, taxi, carpoolen\u2026",
    "Aptitude professionnelle": "Beroepsbekwaamheid",
    "Formation, certificats, CAP\u2026": "Opleiding, certificaten, kwalificatie\u2026",
    "Conditions techniques": "Technische vereisten",
    "Contrôle technique, normes\u2026": "Technische keuring, normen\u2026",
    # _LAW_META strings — views.py
    "Loi du 16 mars 1968 \u2014 Police de la circulation routière": "Wet van 16 maart 1968 \u2014 Wegverkeerswet",
    "Infractions, peines et déchéance du droit de conduire": "Overtredingen, straffen en verval van het recht tot sturen",
    "AM du 11 octobre 1976 \u2014 Dimensions, masse et signalisation": "MB van 11 oktober 1976 \u2014 Afmetingen, massa en signalisatie",
    "Dimensions, poids des véhicules et prescriptions de signalisation": "Afmetingen, gewichten van voertuigen en signalisatievoorschriften",
    "AR du 23 mars 1998 \u2014 Permis de conduire": "KB van 23 maart 1998 \u2014 Rijbewijs",
    "Catégories, conditions médicales, échange et retrait du permis": "Categorieën, medische vereisten, omruiling en intrekking rijbewijs",
    "AR du 30 septembre 2005 \u2014 Infractions par degré": "KB van 30 september 2005 \u2014 Overtredingen per graad",
    "Classement des infractions routières en degrés 1 à 4": "Indeling van verkeersovertredingen in graden 1 tot 4",
    "AR du 10 juillet 2006 \u2014 Permis catégorie B": "KB van 10 juli 2006 \u2014 Rijbewijs categorie B",
    "Formation, examen théorique et pratique, conduite accompagnée": "Opleiding, theoretisch en praktisch examen, begeleid rijden",
    "AR du 15 mars 1968 \u2014 Conditions techniques des véhicules": "KB van 15 maart 1968 \u2014 Technische vereisten voor voertuigen",
    "Exigences techniques pour voitures, camions et remorques": "Technische vereisten voor auto's, vrachtwagens en aanhangwagens",
    "Loi du 21 juin 1985 \u2014 Conditions techniques (loi-cadre)": "Wet van 21 juni 1985 \u2014 Technische vereisten (kaderwet)",
    "Loi-cadre sur les conditions techniques des véhicules de transport": "Kaderwet technische vereisten voor transportvoertuigen",
    "Loi du 21 novembre 1989 \u2014 Assurance RC obligatoire": "Wet van 21 november 1989 \u2014 Verplichte BA-verzekering",
    "Assurance obligatoire de la responsabilité des véhicules automoteurs": "Verplichte aansprakelijkheidsverzekering voor motorvoertuigen",
    "AR du 20 juillet 2001 \u2014 Immatriculation des véhicules": "KB van 20 juli 2001 \u2014 Inschrijving van voertuigen",
    "Conditions et procédures d'immatriculation, plaques minéralogiques": "Voorwaarden en procedures voor inschrijving, nummerplaten",
}
...
RU = {
    ...
    # Corrections (wrong values from previous run)
    "Masquer": "Скрыть",
    "Voir les options": "Смотреть варианты",
    "Voir les résultats": "Посмотреть результаты",
    "Question suivante →": "Следующий вопрос →",
    "correctes": "правильных",
    "questions correctes": "правильных ответов",
    "Voir tous": "Все",
    # New strings — Part B templates
    "Par %(author)s": "Автор: %(author)s",
    "Articles similaires": "Похожие статьи",
    "Aperçu admin — Question #%(id)s": "Предпросмотр — Вопрос #%(id)s",
    "pause": "пауза",
    "Confirmer": "Подтвердить",
    "Temps écoulé !": "Время истекло!",
    "Bonne réponse !": "Правильный ответ!",
    "Mauvaise réponse": "Неправильный ответ",
    "Aperçu terminé": "Предпросмотр завершён",
    "Félicitations !": "Поздравляем!",
    "Continuez à vous entraîner": "Продолжайте тренироваться",
    "%(s)s / %(t)s bonnes réponses": "%(s)s / %(t)s правильных ответов",
    "Temps :": "Время:",
    "Détail des réponses": "Детали ответов",
    "Cliquez sur le signet pour sauvegarder": "Нажмите на закладку для сохранения",
    ...
    "Difficile": "Сложный",
    "répondues": "отвечено",
    "Article précédent": "Предыдущая статья",
    "Article suivant": "Следующая статья",
    "Sommaire — %(name)s": "Содержание — %(name)s",
    "← Précédent": "← Назад",
    "Suivant →": "Вперёд →",
    "Apprenez à reconnaître tous les panneaux routiers belges.": "Научитесь распознавать все бельгийские дорожные знаки.",
    ...
    # Theme cards — index.html
    "Règles de circulation": "Правила движения",
    "Priorité, vitesse, dépassement\u2026": "Приоритет, скорость, обгон\u2026",
    "Infrastructure et signalisation": "Инфраструктура и знаки",
    "Panneaux, marquages, feux\u2026": "Знаки, разметка, светофоры\u2026",
    "Politique criminelle": "Уголовная политика",
    "Sanctions, amendes, procédures\u2026": "Санкции, штрафы, процедуры\u2026",
    "Permis de conduire": "Водительские права",
    "Catégories, examen, validité\u2026": "Категории, экзамен, срок действия\u2026",
    "Assurance et immatriculation": "Страхование и регистрация",
    "Plaques, assurance RC, contrôle\u2026": "Номера, страхование, техосмотр\u2026",
    "Transport de marchandises": "Грузовые перевозки",
    "ADR, poids lourds, chargement\u2026": "ADR, грузовики, погрузка\u2026",
    "Transport de personnes": "Пассажирские перевозки",
    "Bus, taxis, covoiturage\u2026": "Автобус, такси, карпулинг\u2026",
    "Aptitude professionnelle": "Профессиональная квалификация",
    "Formation, certificats, CAP\u2026": "Обучение, сертификаты, квалификация\u2026",
    "Conditions techniques": "Технические требования",
    "Contrôle technique, normes\u2026": "Технический осмотр, нормы\u2026",
    # _LAW_META strings — views.py
    "Loi du 16 mars 1968 \u2014 Police de la circulation routière": "Закон от 16 марта 1968 \u2014 Дорожно-транспортная полиция",
    "Infractions, peines et déchéance du droit de conduire": "Нарушения, наказания и лишение водительских прав",
    "AM du 11 octobre 1976 \u2014 Dimensions, masse et signalisation": "МП от 11 октября 1976 \u2014 Габариты, масса и знаки",
    "Dimensions, poids des véhicules et prescriptions de signalisation": "Габариты, вес транспортных средств и требования к знакам",
    "AR du 23 mars 1998 \u2014 Permis de conduire": "КУ от 23 марта 1998 \u2014 Водительские права",
    "Catégories, conditions médicales, échange et retrait du permis": "Категории, медицинские требования, замена и изъятие прав",
    "AR du 30 septembre 2005 \u2014 Infractions par degré": "КУ от 30 сентября 2005 \u2014 Нарушения по степени",
    "Classement des infractions routières en degrés 1 à 4": "Классификация дорожных нарушений по степеням от 1 до 4",
    "AR du 10 juillet 2006 \u2014 Permis catégorie B": "КУ от 10 июля 2006 \u2014 Права категории B",
    "Formation, examen théorique et pratique, conduite accompagnée": "Обучение, теоретический и практический экзамен, сопровождаемое вождение",
    "AR du 15 mars 1968 \u2014 Conditions techniques des véhicules": "КУ от 15 марта 1968 \u2014 Технические требования к транспортным средствам",
    "Exigences techniques pour voitures, camions et remorques": "Технические требования к легковым, грузовым и прицепным транспортным средствам",
    "Loi du 21 juin 1985 \u2014 Conditions techniques (loi-cadre)": "Закон от 21 июня 1985 \u2014 Технические требования (рамочный закон)",
    "Loi-cadre sur les conditions techniques des véhicules de transport": "Рамочный закон о технических требованиях к транспортным средствам",
    "Loi du 21 novembre 1989 \u2014 Assurance RC obligatoire": "Закон от 21 ноября 1989 \u2014 Обязательное страхование ГО",
    "Assurance obligatoire de la responsabilité des véhicules automoteurs": "Обязательное страхование гражданской ответственности автовладельцев",
    "AR du 20 juillet 2001 \u2014 Immatriculation des véhicules": "КУ от 20 июля 2001 \u2014 Регистрация транспортных средств",
    "Conditions et procédures d'immatriculation, plaques minéralogiques": "Условия и процедуры регистрации, автомобильные номера",
}
...
def fill_po(path, translations):
    ...
    # Replace msgstr blocks: overwrite if msgid is in our dict (also fixes wrong translations)
    result = re.sub(
        r'msgid "([^"]*(?:\\"[^"]*)*)"\nmsgstr "(?:[^"]*(?:\\"[^"]*)*)"',
        replace_msgstr,
        content
